...
func tmplCmdUpdateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/cmd.update.tmpl", size: 502, mode: os.FileMode(0644), modTime: time.Unix(1693643888, 0)}
