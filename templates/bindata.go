...
// tmpl/cliitems.root.tmpl (1.498kB)
// tmpl/cliitems.update.tmpl (502B)
...
func tmplCliitemsRootTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/cliitems.root.tmpl", size: 1498, mode: os.FileMode(0644), modTime: time.Unix(1691936560, 0)}
...
func tmplCliitemsUpdateTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/cliitems.update.tmpl", size: 502, mode: os.FileMode(0644), modTime: time.Unix(1691936563, 0)}
